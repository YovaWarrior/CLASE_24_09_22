...
void escribir()
{
    ...
    miarchivo.open("Escritorio://c++//15 de Septiembre.txt", ios::out);   //abrir el archivo , pero si no existe el archivo con ese nombre se crea y se le nombra con el texto dentro de las comillas
